defmodule Api.Pipeline.TitleGeneration do
  @moduledoc "Business logic for generating and updating chat titles."

  def get_conversation(chat_id, user_id) do
  ...
  def generate_title(api_key, chat_id, user_id) do
  ...
  def broadcast_rename(chat_id, user_id, chat_name) do
  ...
  def handle_rename(chat_id, user_id, new_name) do
