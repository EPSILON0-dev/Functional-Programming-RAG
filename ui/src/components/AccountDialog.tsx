...
import { IconSun, IconMoon, IconUser, IconSettings, IconLogout, IconKey } from "@tabler/icons-react";
...
export function AccountDialog() {
  ...
  return (
    <>
      ...
      <ApiKeySettingsDialog open={apiKeysOpen} onOpenChange={setApiKeysOpen} />
